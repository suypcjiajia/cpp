...
var unitsShop =
        [
         ...
         // {info:'测试 Black',port:23241,path:'/?sMethod=Black&sBusiness=UserRelation'
        //  , post_data:{ lUserId : 60001, lToUserId : 60002}}
        //  {info:'测试 DelFri',port:23241,path:'/?sMethod=DelFri&sBusiness=UserRelation'
         //, post_data:{ lUserId : 61650, lToUserId : 93525}}
         // {info:'测试 SetMark',port:23241,path:'/?sMethod=SetMark&sBusiness=UserRelation'
          //, post_data:{ lUserId : 50032, lToUserId : 50033 , sMark : "sususu"}}
          {info:'测试 MyFriends',port:23241,path:'/?sMethod=MyFriends&sBusiness=UserRelation'
          , post_data:{ lUserId : 50037 , lUpTime : 0 ,iPage : 1,iCount : 1000}}
        //  {info:'测试 MyFriends',port:23241,path:'/?sMethod=MyFriends&sBusiness=UserRelation'
       //   , post_data:{ lUserId : 128898 , lUpTime : 0}},

      //  {info:'测试 Contacts',port:23241,path:'/?sMethod=Contacts&sBusiness=UserRelation'
      //    , post_data:{ lUserId : 52599 , "sContacts":[{sName:'suyp',sPhoneNum:'13411367357'},{sName:'suyp1',sPhoneNum: '13257563326'}]}},
       //   {info:'测试 MyFriends',port:23241,path:'/?sMethod=MyFriends&sBusiness=UserRelation'
