...
var unitsShop =
        [
          ...
          {info:'测试 IfAudit',port:2234,path:'/?sMethod=Count&sBusiness=IfAudit'
          , post_data:{"lUserId":"52599","iTimes":"1","sInterface":"http://192.168.168.158/get"}}


        //  {info:'测试 GetHotUser',port:2234,path:'/?sMethod=GetHotUser&sBusiness=IfAudit'
        //  , post_data:{"sMonth":['2017-05','2017-06']}}
